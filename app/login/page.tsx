    ...
    <div className="min-h-screen flex relative overflow-hidden bg-gray-50/20">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md bg-white/40 backdrop-blur-2xl border border-white/50 p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)]">
          ...
          <p className="text-muted-foreground mb-8">Masuk ke dashboard Anda</p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 bg-muted border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-sm"
                  placeholder="••••••••"
                  required
                />
                <button
